...
class ExchangeConnections {
    ...
    func keyJoin(session: String, exchangeName: String, accessKey: String, secretKey: String, exchangeKeyJoinHandler: @escaping (Result<ExchangeJoinResponseModel, Error>) -> Void) {
