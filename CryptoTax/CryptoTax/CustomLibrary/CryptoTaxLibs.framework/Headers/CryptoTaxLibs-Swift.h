...
#ifndef CRYPTOTAXLIBS_SWIFT_H
#define CRYPTOTAXLIBS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CryptoTaxLibs",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13CryptoTaxLibs15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(CryptoTaxLibs)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(CryptoTaxLibs)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(CryptoTaxLibs)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(CryptoTaxLibs)) <NSURLSessionTaskDelegate>
